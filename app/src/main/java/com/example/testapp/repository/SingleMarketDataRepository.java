...
/**
 * Created by SAKET on 14/09/2020
 */
public class SingleMarketDataRepository {
    private static SingleMarketDataRepository marketRepository;
    private MutableLiveData<BaseApiResponse.MarketDataDataEvent> mutableLiveData;

    public static SingleMarketDataRepository getInstance() {
        if(marketRepository==null) {
            marketRepository = new SingleMarketDataRepository();
        }
        return marketRepository;
    }

    private SingleMarketDataRepository() {}
